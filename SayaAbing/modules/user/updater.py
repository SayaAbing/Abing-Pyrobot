...
from SayaAbing.helpers.misc import HAPP, XCB
from SayaAbing.helpers.tools import get_arg
from SayaAbing.utils.misc import restart
from SayaAbing.utils.pastebin import PasteBin
from SayaAbing.utils.tools import bash
...
async def upstream(client: Client, message: Message):
    ...
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return
        await status.edit(
            "`[HEROKU]: Update Deploy Abing-Pyrobot Sedang Dalam Proses...`"
        )
        ups_rem.fetch(ac_br)
        ...
        try:
            ...
            pass
        await status.edit(
            "`Abing-Pyrobot Berhasil Diupdate! Userbot bisa di Gunakan Lagi.`"
        )
    else:
        try:
            ups_rem.pull(ac_br)
        ...
        args = [sys.executable, "-m", "SayaAbing"]
...
add_command_help(
    "update",
    [
        ["update", "Untuk melihat list pembaruan terbaru dari Abing-Pyrobot."],
