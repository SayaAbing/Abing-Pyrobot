...
from SayaAbing import BOTLOG_CHATID
...
async def inv(client: Client, message: Message):
    ...
    tgchat = message.chat
    await SayaAbing.edit_text(f"inviting users from {chat.username}")
...
async def invite_link(client: Client, message: Message):
    ...
    if message.chat.type in [ChatType.GROUP, ChatType.SUPERGROUP]:
        ...
        try:
            ...
            await SayaAbing.edit(f"**Link Invite:** {link}")
        except Exception:
            await SayaAbing.edit("Denied permission")
