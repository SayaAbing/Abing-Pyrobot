...
from SayaAbing.helpers.misc import HAPP, in_heroku
from SayaAbing.helpers.tools import get_arg
from SayaAbing.utils.misc import restart

from .help import *

while 0 < 6:
    _GCAST_BLACKLIST = get(
        "https://github.com/SayaAbing/AbingBlacklist/blob/master/blacklistgcast.json"
    )
    if _GCAST_BLACKLIST.status_code != 200:
        if 0 != 5:
            continue
        GCAST_BLACKLIST = [-1001608701614, -1001451642443, -1001473548283, -1001982790377, -1001812143750, -1001692751821 -1001390552926, -1001001675459127, -1001864253073, -1001565255751, -1001287188817, -1001876092598, -1001562283549, -1001001951726069, -1001861414061, -1001987342310, -1001994121863]
...
async def gcast_cmd(client: Client, message: Message):
    if message.reply_to_message or get_arg(message):
        Man = await edit_or_reply(message, "`ɢᴄᴀꜱᴛ ɢᴀᴜꜱᴀʜ ʙᴀɴʏᴀᴋ-ʙᴀɴʏᴀᴋ ᴋᴏɴᴛᴏʟ ɴᴀɴᴛɪ ʟɪᴍɪᴛ ʙᴇɢᴏ...`")
    else:
