...
from SayaAbing import CMD_HELP, StartTime
...
from SayaAbing.helpers.tools import convert_to_image
from SayaAbing.utils import get_readable_time
...
async def setalivelogo(client: Client, message: Message):
    ...
    if message.reply_to_message.media:
        ...
        try:
            ...
            await SayaAbing.edit(f"**ERROR:** `{exc}`")
            os.remove(m_d)
            return
...
async def setalivetext(client: Client, message: Message):
    ...
    await SayaAbing.edit(f"**Berhasil Mengcustom ALIVE TEXT Menjadi** `{text}`")
    restart()
...
async def setemoji(client: Client, message: Message):
    ...
    await SayaAbing.edit(f"**Berhasil Mengcustom EMOJI ALIVE Menjadi** {emoji}")
    restart()
