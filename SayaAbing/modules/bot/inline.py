...
from SayaAbing.helpers.data import Data
from SayaAbing.helpers.inline import inline_wrapper, paginate_help
from config import BOT_VER, BRANCH as branch
from SayaAbing import CMD_HELP, StartTime, app
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph//file/8a6d0f40b08fc83151e8b.jpg",
...
async def peler_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ", url="t.me/ab1ngstore"), InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="t.me/akuab1ng")], [InlineKeyboardButton(text="ᴍᴇɴᴜ", callback_data="reopen")]]
            ),
        )
    )
    return answers
