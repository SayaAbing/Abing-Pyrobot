...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("SayaAbing").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("SayaAbing").info(f"Invalid Git Command")
        ...
        LOGGER("SayaAbing").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("SayaAbing").info(f"Heroku App Configured")
